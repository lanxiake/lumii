...
export function useDashboard() {
    ...
    const { data: systemInfo, isLoading: isSystemLoading, refetch: refetchSystem, } = useQuery<SystemInfoShape | null>({
    ...
    const { data: skillStats, isLoading: isSkillLoading, refetch: refetchSkills, } = useQuery<SkillStats>({
        queryKey: ['dashboard', 'skills'],
        queryFn: fetchSkills,
        retryCount: 0,
    });
    const { data: usage, isLoading: isUsageLoading, isRefetching: isUsageRefetching, error: usageError, refetch: refetchUsage, } = useQuery<UsageView>({
