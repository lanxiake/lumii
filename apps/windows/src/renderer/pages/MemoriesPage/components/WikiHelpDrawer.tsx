...
const QUICK_SECTIONS = [
  {
    title: '资料库是什么',
    body: 'Wiki 是你的个人资料库：文件与文档集中存放，可搜索、可预览。与「工作记忆」「个人记忆」不同，这里存的是真实资料正文。编写文档时可将链接嵌入正文，但不会单独收录网页链接。',
  },
  {
    title: '资料怎么进来',
    body: '聊天里上传附件、任务产物会自动进入「收件箱」。默认只建立引用，不会移动或删除原文件。网页搜索结果不会自动收录，避免无用信息堆积。',
  },
  {
    title: '从文件夹导入',
    body: '收件箱右上角「从文件夹导入」：选一个目录（如 outputs/ 下的任务文件夹），系统会预览可导入文件数量，确认后批量收进 Wiki。原文件保留在原处，Wiki 只建立引用。是否在导入后 AI 自动分类，由左栏「⋯ 更多 → AI 自动分类」开关决定（默认关闭）。',
  },
  {
    title: '让 Agent 帮忙整理',
    body: '在聊天中说「帮我把 outputs/某目录整理到 Wiki」即可。Agent 会通过 lumii-ui 扫描并导入；若你已在 Wiki 开启「AI 自动分类」，导入后会尝试 AI 归档，拿不准的条目仍留在收件箱，你可批量归档或重试。',
  },
  {
    title: '收件箱怎么用（推荐流程）',
    body: '1. 左栏点「收件箱」查看新资料\n2. 勾选多条 →「批量归档到…」一次放入同一分类\n3. 失败或「待人工归档」的条目 →「全部重试」或逐条「归档到…」\n4. 拿不准分类可暂时留在收件箱，没有对错',
  },
  {
    title: '分类怎么选',
    body: '工作：项目/会议/汇报 · 学习：笔记/课程/资料 · 生活：证件/家庭/随笔 · 收藏：模板/参考 · 归档：暂时不用。归档时可点「让 AI 建议」参考分类，采纳与否由你决定。',
  },
  {
    title: '入口在哪里',
    body: '聊天工具栏书本图标、输入框「+」菜单「打开资料库」，以及 设置 → 记忆 → Wiki。',
  },
  {
    title: '高级功能（⋯ 更多）',
    body: 'AI 自动分类（开关）、清理、重建索引、编辑主题树、全库重新编目（只调整已进目录的文件；收件箱请用「让 AI 分类」）。日常整理用不到时可忽略；鼠标悬停各菜单项可查看简要说明。',
  },
  {
    title: '文件存在哪',
