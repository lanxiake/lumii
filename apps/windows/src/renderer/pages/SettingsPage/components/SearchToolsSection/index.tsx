...
export function SearchToolsSection() {
    ...
    if (loading) {
        return (<Card className={styles.settingCard}>
      ...
      <div className={styles.settingCardContent}>
        ...
        <div className={styles.formGroup}>
          ...
          <div style={{ position: 'relative' }}>
            <Input id="langSearchApiKey" type={showApiKey ? 'text' : 'password'} value={langSearchApiKey} onChange={(e) => setLangSearchApiKey(e.target.value)} placeholder="sk-xxxxxxxxxxxxxxxx" className={styles.input}/>
          ...
          <p className={styles.fieldHint}>
            ...
            <a href="https://langsearch.com" target="_blank" rel="noopener noreferrer" style={{ marginLeft: '4px', color: 'var(--primary)' }}>
              申请 API Key
            </a>
          </p>
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          <Input id="searxngBaseUrl" type="url" value={searxngBaseUrl} onChange={(e) => setSearxngBaseUrl(e.target.value)} placeholder="https://www.mtbot.top/searxng" className={styles.input}/>
          <p className={styles.fieldHint}>
