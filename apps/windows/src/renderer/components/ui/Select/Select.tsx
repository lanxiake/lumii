...
const Select = forwardRef<HTMLSelectElement, SelectProps>(({ options, label, placeholder, error, disabled, className = '', ...props }, ref) => {
    return (<div className={clsx(styles['select-wrapper'], error && styles['select-wrapper-error'], disabled && styles['select-wrapper-disabled'], className)}>
