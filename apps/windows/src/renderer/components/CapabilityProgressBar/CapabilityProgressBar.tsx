...
import { TIP_CAPABILITY_FIELD, TIP_DIMENSION, } from '../../pages/AutonomousPage/autonomousTooltips';
 ...
 * 能力进度条组件
 */
export function CapabilityProgressBar({ dimension, level, confidence, testCount, trend = 'stable', }: CapabilityProgressBarProps) {
    ...
    return (<div className="capability-progress-bar">
      ...
      <div className="progress-container" title={TIP_CAPABILITY_FIELD.level}>
        ...
        <div className="progress-bar">
          <div className="progress-fill" style={{ width: `${level * 100}%` }}/>
        </div>

        {/* 置信度指示器（虚线边框） */}
        <div className="confidence-indicator" style={{ width: `${confidence * 100}%` }} title={TIP_CAPABILITY_FIELD.confidence}/>
      </div>
