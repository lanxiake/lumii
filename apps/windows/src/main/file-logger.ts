 ...
 */
function cleanLogsByPrefix(logDir: string, prefix: string, maxFiles: number, excludePrefixes: readonly string[] = []): void {
    try {
...
class FileLogger {
    ...
    private safeConsoleWrite(originalFn: (...args: unknown[]) => void, ...args: unknown[]): void {
