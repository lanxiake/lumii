---
name: Art
description: Create visual content (illustrations, diagrams, infographics, icons). Use ONLY when the user explicitly asks to create or draw visual/graphical content, art, or diagrams. Do NOT use for data queries, weather, or any informational questions.
---
