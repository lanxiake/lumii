...
| BasicScheduler.steps | 8 | 20 | 20 |
| ResolutionSelector.aspect_ratio | 2:3 Portrait | 2:3 Portrait | 2:3 Portrait |
| SaveVideo.filename_prefix | ..._fast_ | ..._normal_ | ..._final_ |
| 最大时长 | 5/10/15s | 5/10/15s | **≤10s** |
| 预计耗时(15s·v2) | 5-15 分钟 | 50-70 分钟 | — |
| 预计耗时(10s·v2) | 3-10 分钟 | 30-45 分钟 | ~30-60 分钟 |

> ⚠️ **比例铁律**：竖版人物一律 **2:3 Portrait Photo**，禁止 9:16（会拉伸变形）。  
> ⚠️ **高质量时长**：megapixels 0.9/1.0 仅限 ≤10s（4060Ti 实测15s需2小时+）。
