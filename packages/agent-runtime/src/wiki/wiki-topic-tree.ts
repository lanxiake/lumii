 ...
 *
 * 设计：docs/design/Wiki知识库/2026-08-27-Wiki用途目录重设计.md §1-§2
...
/**
 * v2 默认树：4 大类 × 用途轴小类（每类 8 个，边界见 DEFAULT_SUBTOPIC_HINTS）。
 * 去掉「整合长文」专属小类（综述功能已移除，见 P2）。小类可选。
 */
export const DEFAULT_TOPIC_TREE: WikiTopicTree = {
  version: 2,
  categories: [
    { name: "工作", subtopics: ["项目", "例行", "对外", "协作", "规范", "合同", "招采", "数据"] },
    { name: "学习", subtopics: ["在学", "备考", "练习", "参考", "成果", "技能", "行业", "阅读"] },
    { name: "生活", subtopics: ["凭据", "家事", "财务", "健康", "自留", "出行", "购物", "社交"] },
    { name: "收藏", subtopics: ["待读", "可复用", "范例", "存档", "灵感", "工具", "资讯", "娱乐"] },
  ],
};
