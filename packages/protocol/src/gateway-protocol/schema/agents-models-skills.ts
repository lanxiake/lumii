...
/**
 * skills.listLocal - 获取用户的本地技能列表
 * 不需要参数，使用用户认证信息
 */
export const SkillsListLocalParamsSchema = Type.Object({}, { additionalProperties: false });
export type SkillsListLocalParams = Static<typeof SkillsListLocalParamsSchema>;
