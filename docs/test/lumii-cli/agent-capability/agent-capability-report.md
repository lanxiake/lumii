...
- 日期：2026-08-27
- 用例文档：`docs/test/lumii-cli/agent-capability/agent-capability-test-cases.md`
- 证据文件：`docs/test/lumii-cli/agent-capability/agent-capability-evidence.jsonl`
- 执行器：
  - `docs/test/lumii-cli/agent-capability/run-agent-capability-suite.mjs`
  - `docs/test/lumii-cli/agent-capability/run-agent-capability-suite-continue.mjs`
  - `docs/test/lumii-cli/agent-capability/run-agent-capability-skipped.mjs`
