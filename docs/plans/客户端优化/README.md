...
| 3 · Wiki 样式归位 | 3 个全局样式文件 2847 行 / 310 个类 → 按组件切 module.css，消除 18 文件 × 325 处字面类名耦合；含 58 个死类名 412 行退场（B0） | 大但机械 | 中 | **进行中**（2026-09-12）→ [实施计划](./03-Wiki样式归位.md) · [类名归属对照表](./03a-Wiki类名归属对照表.md) |
