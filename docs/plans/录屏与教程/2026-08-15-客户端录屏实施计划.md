...
**Goal:** 交付 MVP：整屏 + 任意窗口录制（含 Lumii 自身免确认）、画面 + 麦克风混轨 WebM 落盘、AI 四工具全流程可控、人手简易 UI / 托盘救急。对应设计 `docs/design/录屏与教程/2026-08-15-客户端录屏设计.md` §1.2 MVP 必须交付 4 条。
...
**Design:** `docs/design/录屏与教程/2026-08-15-客户端录屏设计.md`（v0.1，设计已评审待实施）
