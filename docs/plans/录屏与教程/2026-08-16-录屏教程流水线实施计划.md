...
**Design:** `docs/design/录屏与教程/2026-08-16-录屏教程流水线设计.md`
...
**Files:**
- Modify: `docs/design/录屏与教程/2026-08-16-录屏教程流水线设计.md` — 状态改为「实施中/已实施」  
- Modify: `docs/design/录屏与教程/2026-08-15-客户端录屏二期设计.md` — 文末加「参见教程流水线设计」  
- Modify: `docs/design/录屏与教程/2026-08-15-录屏字幕编辑器设计.md` — 同上（可选）
...
Plan complete and saved to `docs/plans/录屏与教程/2026-08-16-录屏教程流水线实施计划.md`.
