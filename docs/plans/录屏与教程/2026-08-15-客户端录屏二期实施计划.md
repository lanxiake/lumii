...
**Goal:** 在 MVP 之上交付二期：暂停/继续、系统声、时间线预览、可选 MP4、窗口捕获 B1、停录后 SRT+TTS 配音（默认烧字幕）。对应 `docs/design/录屏与教程/2026-08-15-客户端录屏二期设计.md`。
...
**Design:** `docs/design/录屏与教程/2026-08-15-客户端录屏二期设计.md`
