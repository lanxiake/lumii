...
**规格：**
- 主规格：`docs/design/客户端UI/2026-08-13-Agent操作客户端设计.md` **§14（v0.7）**
- 边界参考：`docs/design/客户端UI/2026-08-15-CLI-Hub外部软件接入设计.md`（**已落地，三期不改代码**）
- 前序计划：`docs/plans/客户端UI/2026-08-14-Agent操作客户端实施计划.md` Part A–C 已完成；本文**取代**该文档 Part D（Task 13–17），按本文执行
