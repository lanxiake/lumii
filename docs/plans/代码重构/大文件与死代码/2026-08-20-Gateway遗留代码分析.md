...
| `docs/plans/客户端UI/2026-08-05-UI技术栈刷新实施计划.md` | 历史计划，保留但不强制更新 |
| `docs/design/渠道与CLI/2026-08-14-渠道出站Hub设计.md` | P5 "message 工具与 Gateway 耦合" L90、L236、L417、L454 — 多处注明 Gateway 遗留分支**已移除**（✅ 标注）。该文件本身是设计文档，保持为历史记录即可。 |
