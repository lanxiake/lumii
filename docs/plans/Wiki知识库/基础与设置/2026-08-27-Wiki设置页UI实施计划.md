...
**Spec:** `docs/design/Wiki知识库/2026-08-27-Wiki设置页UI重设计.md`  
...
- Optional: 更新 `docs/design/Wiki知识库/2026-08-27-Wiki设置页UI重设计.md` §9 标记「实现中/已完成」
...
Plan complete and saved to `docs/plans/Wiki知识库/基础与设置/2026-08-27-Wiki设置页UI实施计划.md`.
