...
> 规格：`docs/design/Wiki知识库/2026-08-31-Wiki智能资料库设计.md`（v1.1）§7
...
- [ ] 确认 P1 迁移 SQL（`docs/plans/Wiki知识库/资料库/2026-08-31-Wiki智能资料库P1分类体系.md`）已把 `legacy_subtopic='整合长文'` 的存量行路由到收件箱——本 Task 只需回归测试确认，不重复实现。
