...
7. `docs/design/记忆与Wiki/参考项目/modelcontextprotocol-servers/设计解构.md/`
...
源设计文档：
- `docs/design/记忆与Wiki/2026-08-24-记忆系统设计.md` 方案 A+ 决策全过程
- `docs/design/记忆与Wiki/2026-08-24-Wiki知识库设计.md` Wiki 三层分离 DDL 全集
