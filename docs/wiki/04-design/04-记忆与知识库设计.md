...
1. `docs/design/记忆与Wiki/mcp-memory-graph/设计解构.md/`
2. `docs/design/记忆与Wiki/memory-graph/设计解构.md/`
3. `docs/design/记忆与Wiki/llm-wiki/设计解构.md/`
4. `docs/design/记忆与Wiki/llm-wiki-knowledge/设计解构.md/`
5. `docs/design/记忆与Wiki/llm-wiki-organizer/设计解构.md/`
6. `docs/design/记忆与Wiki/llm-wiki-vault/设计解构.md/`
7. `docs/reference/开源项目解构/modelcontextprotocol-servers/设计解构.md/`
8. `docs/design/记忆与Wiki/siyuan-note/设计解构.md/`
9. `docs/design/记忆与Wiki/wiki0/设计解构.md/`
10. `docs/design/记忆与Wiki/local-memory-mcp/设计解构.md/`
11. `docs/design/记忆与Wiki/memex/设计解构.md/`

源设计文档：
- `docs/design/记忆系统/2026-08-24-记忆系统设计.md` 方案 A+ 决策全过程
- `docs/design/Wiki知识库/2026-08-24-Wiki知识库设计.md` Wiki 三层分离 DDL 全集
