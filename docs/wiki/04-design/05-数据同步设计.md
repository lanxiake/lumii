...
- 同步策略深度分析（18 行分类矩阵 + 616MB→60MB 体积估算）：`docs/analysis/2026-09-07-多设备数据同步策略分析.md`
- 同步策略架构反思（JSONL 低估 / Git squash 破坏 / 事件溯源路线 / 向量时钟）：`docs/analysis/2026-09-07-同步策略反思.md`
