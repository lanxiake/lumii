...
- Agent 能力测试报告：[`../test/2026-08-27-agent-capability-test-report.md`](../../test/2026-08-27-agent-capability-test-report.md)
- 上下文压缩测试指南：[`../CONTEXT_COMPRESSION_TEST_GUIDE.md`](../../test/2026-08-19-context-compression-test-guide.md)
