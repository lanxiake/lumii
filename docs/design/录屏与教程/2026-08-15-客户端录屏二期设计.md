...
> 日期：2026-08-15  
> 状态：v0.1，设计待实施  
> 基线：MVP 已交付，见 `docs/design/录屏与教程/2026-08-15-客户端录屏设计.md`  
> 实施计划：`docs/plans/录屏与教程/2026-08-15-客户端录屏二期实施计划.md`
...
- 设计：`docs/design/录屏与教程/2026-08-16-录屏教程流水线设计.md`
- 计划：`docs/plans/录屏与教程/2026-08-16-录屏教程流水线实施计划.md`
