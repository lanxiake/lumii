...
> 实施计划：`docs/plans/客户端UI/2026-08-14-Agent操作客户端实施计划.md`  
...
外部软件 harness 的安装与调用见 `apps/windows/bundled-skills/技能管理/cli-hub/SKILL.md` 与 `docs/design/客户端UI/2026-08-15-CLI-Hub外部软件接入设计.md`。
