...
> 前置：[2026-08-29-Wiki资料库引用优先设计.md](./2026-08-29-Wiki资料库引用优先设计.md)（v1.1 已确认，P0 已落地）
> 再前置：[2026-08-27-Wiki用途目录重设计.md](./2026-08-27-Wiki用途目录重设计.md)（v4.1，一/二/三期已实现）
> 实施计划（后续编写）：`docs/plans/记忆与Wiki/2026-08-31-wiki-intelligent-vault-*.md/`
...
*下一步：编写实施计划（`docs/plans/记忆与Wiki/2026-08-31-wiki-intelligent-vault-*.md/`），并同步更新 `docs/test/lumii-cli/` 测试用例与 `docs/guide/wiki-user-guide.md`。*
