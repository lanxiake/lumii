...
> 前置：[2026-08-25-Wiki知识库设计P0P1P2.md](./2026-08-25-Wiki知识库设计P0P1P2.md)（P0/P1 已实现）
> 目标：将 Wiki 从「按来源分类的资料库」改造为「按用途层级组织的文件目录」
> 当前 schema 版本：V21（本设计一次迁到 V22，三期共用，不再为图谱另开版本）
> 原型：[2026-08-27-Wiki用途目录原型.html](./2026-08-27-Wiki用途目录原型.html)
...
与刚落地的 [设置页 UI 重设计](./2026-08-27-Wiki设置页UI重设计.md) 的关系：本设计**替换**其「资料 / 多媒体」一级分区和「详情侧滑」；任务 pill、任务中心、更多菜单壳体保留。
